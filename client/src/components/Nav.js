    ...
    <nav>
      <ul>
        ...
        <li style={{ float: 'right' }}>
          {loggedIn ? (
            <a href="https://spotifyreview.vercel.app/auth/logout" className="login-logout">Log out</a>
          ) : (
            <a href="https://spotifyreview.vercel.app/auth/spotify" className="login-logout">Log in</a>
          )}
        </li>
      </ul>
    </nav>
